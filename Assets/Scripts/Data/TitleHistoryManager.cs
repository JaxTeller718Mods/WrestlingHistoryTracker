...
public static class TitleHistoryManager
{
    ...
    private static void AppendShowMatches(MatchHistoryData history, ShowData show, string promotionName)
    {
        ...
        foreach (var match in show.matches)
        {
            ...
            var result = new MatchResultData
            {
                ...
                wrestlerG = ResolveWrestler(match.wrestlerGId, match.wrestlerG),
                wrestlerH = ResolveWrestler(match.wrestlerHId, match.wrestlerH),
    ...
    private static MatchResultData CloneMatch(MatchResultData source)
    {
        return new MatchResultData
        {
            ...
            wrestlerG = source.wrestlerG,
            wrestlerH = source.wrestlerH,
